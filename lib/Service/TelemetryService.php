...
class TelemetryService {
     ...
     *
     * It also drops a spoofing hole the old docblock claimed to prevent:
     * Util::hasExtendedSupport() falls back to the `extendedSupport` system
     * config value when the registry is missing, so any admin could set it by
     * hand. IRegistry only answers true when a real ISubscription handler is
     * registered.
     *
