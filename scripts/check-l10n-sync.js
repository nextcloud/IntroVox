 ...
 *
 * Why: IntroVox translations round-trip through the Nextcloud Transifex bot. New
 * source strings only become translatable once `npm run l10n:push` regenerates
 * translationfiles/templates/introvox.pot + this manifest and they are committed
...
Fix (decoupled from release — do this now, not at release time):
  npm run l10n:push
  git add translationfiles/templates/introvox.pot l10n/.source-strings.json l10n/.source-count.json
