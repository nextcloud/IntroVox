...
The tour guides you through topics like:

- 📁 **Files** — Upload, share, and manage your files
- 📅 **Calendar** — Organize your schedule and appointments
- 🔍 **Search** — Find files and information quickly
- ⚙️ **Settings** — Customize Nextcloud to your preferences
...
- ⏸️ Close it and come back later (it will reappear on next login)
- ⏭️ Skip it entirely if you prefer to explore on your own

## First Login Experience

When you log in for the first time, IntroVox starts automatically a few seconds after the dashboard loads. You'll see a welcome step with two options:
